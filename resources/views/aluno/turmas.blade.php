...
<div class="my-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="bg-white shadow-md rounded-lg p-4">
            ...
            <a href="{{ route('aluno.turma.detalhes', $turma->id) }}" class="bg-indigo-500 text-white py-1 px-3 rounded-md hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">Detalhes</a>
        </div>
        @endforeach
    </div>
</div>
